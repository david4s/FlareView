...
//    self.layer.shadowColor  = blackColor;
    self.backgroundColor = [UIColor colorWithRed:186/255.0f green:186/255.0f blue:186/255.0f alpha:0.7f];
    self.layer.shadowColor  = [UIColor colorWithRed:186/255.0f green:186/255.0f blue:186/255.0f alpha:0.7f].CGColor;
...
//    FXBlurView *c_oBlurView = [[FXBlurView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height)];
//    [c_oBlurView setBlurRadius:40.0f];
//    [c_oBlurView setDynamic:NO];
//    c_oBlurView.tintColor = [UIColor clearColor];
////    UIView *view = [[UIView alloc] initWithFrame:c_oBlurView.frame];
////    [view setBackgroundColor:[UIColor colorWithRed:186/255.0f green:186/255.0f blue:186/255.0f alpha:0.7f]];
//    [self insertSubview:c_oBlurView belowSubview:self.titleLabel];
//    [self insertSubview:view belowSubview:self.titleLabel];
    
//    UIImageView *blurView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height)];
//    blurView.backgroundColor = [UIColor clearColor];
//    blurView.image = [[UIImage alloc] blurredImageWithRadius:40.f iterations:40 tintColor:[UIColor colorWithRed:186/255.0f green:186/255.0f blue:186/255.0f alpha:0.7f]];
